       ...
       <tbody>';
          ...
          while($filas = $listado_usuarios->fetch_array()){
           ...
           echo '<tr class="'.$clase.'">
                   ...
                   <td class="">
                      <button onclick="cargarDatosModificar('.$contador.');" data-toggle="modal" data-target="#modal_usuario" type="button" class="btn btn-block btn-warning" style="background-color: #F2E660; color:#000000; font-weight: bold;" name="button">Editar</button>
