      ...
      <div class="col-12 col-md-3">
       ...
       <div class="col-12 col-md-9">
          ...
          <div  style="" class=" card col-12">
            <div class="container">
                 <button type="button" onclick="limpiarFormularioUsuario();" style="background-color: #F2E660; color:#000000; font-weight: bold;" class="btn btn-warning" data-target="#modal_usuario" data-toggle="modal" name="button">Crear nuevo usuario</button>
            </div>
            <div class="container">
              <br>
